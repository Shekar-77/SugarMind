...
class Chatbot:
    ...
    def __init__(self, rawinput, activity_name):
        ...
        self.messages_gears = []
        self.messages_3d_volume = []
        self.raw_input = rawinput
        self.activity_name = activity_name

        self.summary_gears = self.extract_reflection_data(json_input = rawinput)
        self.summary_3d_volume = self.extract_reflection_data(json_input = raw_input2)
        print(f"The summary:{self.summary}")
        ...
        self.logic_system_prompt = logic_agent(user_progress = self.summary, activity_description = self.activity_description)
        self.emo_system_prompt = emo_agent(user_progress = self.summary, activity_description = self.activity_description)
        self.gen_system_prompt = gen_agent(user_progress = self.summary, activity_description = self.activity_description)
    ...
    def extract_3d_volume_color_data(self, json_input):
        ...
        try:
            ...
            result = {
                ...
                "stroke_color_text": self.et_color_name(stroke_hex_text) if stroke_hex_text else None,
